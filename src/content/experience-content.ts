...
export const experienceContent: Experience[] = [
  ...
  },
  {
    ...
    subRole: {
      title: 'Software Engineer',
      description:
        'I worked primarily on Ford.co.uk, where I developed new features across the site including on the dealer locator & car configurator. I also gained experience launching to multiple countries and languages, and worked creating microsites for promotional events and marketing initiatives.',
    },
  },
]
